...
| 9 | Restaurant optimizer | Chain + menu item database, macro-friendly rankings (protein/kcal ratio, cutting/bulking scores), community-submitted items, go-to orders, trending orders nearby | [06-recipes](06-recipes-voting-reputation.md) §7 |
